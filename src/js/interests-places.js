...
$(document).ready(function(){
    $('.pop-up__open').on("click", function(){
        ...
        switch (identificator){
            case "1":
                obj_info = {
                    img: '<img src="https://uain.press/_uploads/2020/08/muzej-1068x624.jpg">',
            ...
            case "9":
                obj_info = {
                    img: '<img src="https://lh3.googleusercontent.com/proxy/VuTNPCLYB2Z1SuYlCxeAMbWM-XrGR-5At0892LtoncQ8TfaiZzC4eyZ9H2ZpuEK0VvWw2dcqHexq8TfV3e-Iwszf6Xnr1cIPlctzZCiFJO55hhqA2JRZ1AsDYqa6MQ">',
